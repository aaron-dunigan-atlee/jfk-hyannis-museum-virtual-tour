...
public class NoNetworkAlertDialog extends DialogFragment {
    ...
    public interface NoNetworkAlertListener {
        void onNoNetworkDialogSettingsClick(DialogFragment dialog);
        void onNoNetworkDialogQuitClick(DialogFragment dialog);
        void onNoNetworkDialogTryAgainClick(DialogFragment dialog);
    }

    // Use this instance of the interface to deliver action events
    private NoNetworkAlertListener mListener;
