...
class HistoryRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public RemoteViews getViewAt(int position) {
        ...
        RemoteViews views = new RemoteViews(mContext.getPackageName(), org.jfkhyannismuseum.enhancedtour.R.layout.widget_history_list_item);
        views.setTextViewText(org.jfkhyannismuseum.enhancedtour.R.id.widget_text_history_item, exhibitPieceTitle);
        ...
        views.setOnClickFillInIntent(org.jfkhyannismuseum.enhancedtour.R.id.widget_text_history_item, fillInIntent);
