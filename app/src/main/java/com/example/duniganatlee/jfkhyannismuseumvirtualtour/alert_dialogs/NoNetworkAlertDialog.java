...
public class NoNetworkAlertDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage(R.string.no_network_alert_message)
                .setTitle(R.string.no_network_alert_title);
        builder.setNegativeButton(R.string.quit_no_network_alert, new DialogInterface.OnClickListener() {
            @Override
        ...
        builder.setNeutralButton(R.string.try_again_no_network_alert, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
        ...
        builder.setPositiveButton(R.string.settings_no_network_alert, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
